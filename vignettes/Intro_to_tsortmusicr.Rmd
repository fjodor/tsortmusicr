...
The following plotting function is available:

**tsm_ggbox(data)**: ggplot2 boxplot additionally showing original data points using a slightly customized theme.
