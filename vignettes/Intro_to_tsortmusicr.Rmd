...
**ch2k_read_songs()**: Wrapper around readr::read_csv to read Top 5000 songs from tsort.info, with convenient defaults (url, file name, NA encoding).

**ch2k_read_albums()**: Wrapper around readr::read_csv to read Top 3000 albums from tsort.info, with convenient defaults.

**ch2k_get_version()** retrieves the current version of the data at https://tsort.info/ as noted at this web address:
